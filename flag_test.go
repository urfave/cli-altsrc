...
func TestStringSliceApplyInputSourceValue_Alias(t *testing.T) {
	...
	tis := testApplyInputSource{
		Flag:     NewStringSliceFlag(&cli.StringSliceFlag{Name: "test", Aliases: []string{"test_alias"}, Destination: &destValue}),
		FlagName: "test_alias",
		MapValue: []interface{}{"hello", "world"},
	}
	c := runTest(t, tis)
	expect(t, c.StringSlice("test_alias"), []string{"hello", "world"})
	expect(t, destValue, []string{"hello", "world"})
	...
	refute(t, destValue, []string{"hello", "world"})
}
